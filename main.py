...
def create_objects(program):
    ...
    objects.append( create_head_outline(program, x=100, y=100, R=0.43, G=0.17, B=0.25, mode=GL_LINE_LOOP) )

    # Head outline
    fixed_objects.append( create_head_outline(program, R=0.43, G=0.17, B=0.25, mode=GL_LINE_LOOP) )

    # Phineas Shirt
    fixed_objects.append( create_triangle(program, x=0.0, y=-0.59, R=0.98, G=0.93, B=0.83, mode=GL_TRIANGLE_STRIP) )
    fixed_objects.append( create_ellipse(program, x=-0.031, y=-0.22, radius=0.062, eccentricity=0.75, R=0.96, G=0.49, B=0.21, mode=GL_TRIANGLE_FAN) )

    # Hair
    objects.append( create_hair(program=program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=1.6, scale_y=1.6, R=0.87, G=0.18, B=0.09, mode=GL_TRIANGLE_FAN ) )
    # Hair outline
    fixed_objects.append( create_hair_outline(program=program, x=-0.4, y=1, scale_x=1.6, scale_y=1.6, R=0.43, G=0.17, B=0.25, mode=GL_LINE_STRIP ) )
    # Head
    objects.append( create_head(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), R=0.98, G=0.72, B=0.60, mode=GL_TRIANGLE_STRIP) )
    # Nose
    objects.append( create_nose(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=0.05, scale_y=0.05, R=0.81, G=0.49, B=0.39, mode=GL_TRIANGLE_STRIP) )
    # Mouth
    objects.append( create_mouth(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=0.25, scale_y=0.25, R=0.39, G=0.01, B=0.02, mode=GL_TRIANGLE_FAN) )

    # Ears
    objects.append( create_ear(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=1.05, scale_y=1.05, R=0.98, G=0.72, B=0.60, mode=GL_TRIANGLE_FAN) )
    objects.append( create_ear_line(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=-1.05, scale_y=1.05, R=0.81, G=0.49, B=0.39, mode=GL_LINE_STRIP) )
    objects.append( create_ear(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=1.05, scale_y=1.05, R=0.98, G=0.72, B=0.60, mode=GL_TRIANGLE_FAN) )
    objects.append( create_ear_line(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), scale_x=1.05, scale_y=1.05, R=0.81, G=0.49, B=0.39, mode=GL_LINE_STRIP) )

    # Eyes contour
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=-20.0, radius=0.1, eccentricity=1.4, R=0.0, G=0.0, B=0.0, mode=GL_TRIANGLE_FAN) )
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=20.0, radius=0.1, eccentricity=1.4, R=0.0, G=0.0, B=0.0, mode=GL_TRIANGLE_FAN) )
    
    # Eyes balls
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=-20.0, radius=0.097, eccentricity=1.4, R=1.0, G=1.0, B=1.0, mode=GL_TRIANGLE_FAN) )
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=20.0, radius=0.097, eccentricity=1.4, R=1.0, G=1.0, B=1.0, mode=GL_TRIANGLE_FAN) )
    
    # Eyes Iris
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=0.0, radius=0.05, eccentricity=1.3, R=0.094, G=0.109, B=0.388, mode=GL_TRIANGLE_FAN) )
    objects.append( create_ellipse(program, x=( random.randint(1, 50)/-100 ), y=( random.randint(1, 50)/-100 ), rotation=0.0, radius=0.05, eccentricity=1.3, R=0.094, G=0.109, B=0.388, mode=GL_TRIANGLE_FAN) )
